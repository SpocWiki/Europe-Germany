...
instance of:
  ...
  - "[[_Standards/db/port settlement]]"
  - "[[_Standards/db/Einheitsgemeinde of Germany]]"
  - "[[_Standards/db/urban municipality in Germany]]"
  - "[[_Standards/db/urban district of Hamburg]]"
  - "[[_Standards/db/free imperial city]]"
located in or next to body of water:
  - "[[_Standards/db/Wedeler Au]]"
  - "[[_Standards/db/Wandse]]"
  - "[[_Standards/db/Flottbek]]"
  - "[[_Standards/db/Tarpenbek]]"
  - "[[_Standards/db/Osterbek]]"
  - "[[_Standards/db/Este]]"
  - "[[_Standards/db/Köhlbrand]]"
  - "[[_Standards/db/Süderelbe]]"
  - "[[_Standards/db/Rodenbek]]"
  - "[[_Standards/db/Bredenbek]]"
  - "[[_Standards/db/Isebekkanal]]"
  - "[[_Standards/db/Goldbekkanal]]"
  - "[[_Standards/db/Rethe]]"
  - "[[_Standards/db/Saselbek]]"
  - "[[_Standards/db/Seevekanal]]"
  - "[[_Standards/db/Susebek]]"
  - "[[_Standards/db/Alster]]"
  - "[[_Standards/db/Elbe]]"
  - "[[_Standards/db/North Sea]]"
  - "[[_Standards/db/Bille]]"
twinned administrative body:
  - "[[_Standards/db/Valdivia]]"
  - "[[_Standards/db/León]]"
  - "[[_Standards/db/Saint Petersburg]]"
  - "[[_Standards/db/Prague]]"
  - "[[_Standards/db/Chicago]]"
  - "[[_Standards/db/Dresden]]"
  - "[[_Standards/db/Kaliningrad]]"
  - "[[_Standards/db/Kyiv]]"
  - "[[_Standards/db/Dar es Salaam]]"
  - "[[_Standards/db/Varna]]"
  - "[[_Standards/db/Shanghai]]"
  - "[[_Standards/db/Marseille]]"
  - "[[_Standards/db/São Paulo]]"
  - "[[_Standards/db/Osaka]]"
  - "[[_Standards/db/Auckland]]"
different from: "[[_Standards/db/Hamburg]]"
described by source:
  ...
  - "[[_Standards/db/Encyclopedic Lexicon]]"
  ...
  - "[[_Standards/db/Topographia Saxoniae Inferioris]]"
  - "[[_Standards/db/Great Soviet Encyclopedia (1926–1947)]]"
  - "[[_Standards/db/Q119138605]]"
history of topic: "[[_Standards/db/history of Hamburg]]"
demographics of topic: "[[_Standards/db/demographics of Hamburg]]"
official symbol: "[[_Standards/db/Hammonia]]"
capital of: "[[_Standards/db/Bouches-de-l'Elbe]]"
significant event:
  - "[[_Standards/db/staple right]]"
  - "[[_Standards/db/Boerse Hamburg - Regulierter Markt]]"
shares border with:
  - "[[_Standards/db/Neu Wulmstorf]]"
  - "[[_Standards/db/Reinbek]]"
  - "[[_Standards/db/Halstenbek]]"
  - "[[_Standards/db/Bönningstedt]]"
  ...
  - "[[_Standards/db/Norderstedt]]"
  - "[[_Standards/db/Stade]]"
  - "[[_Standards/db/Harburg]]"
  - "[[_Standards/db/Seevetal]]"
coat of arms: "[[_Standards/db/coat of arms of Hamburg]]"
legislative body: "[[_Standards/db/Hamburg Parliament]]"
flag: "[[_Standards/db/flag of Hamburg]]"
member of:
  - "[[_Standards/db/Mayors for Peace]]"
  - "[[_Standards/db/Wendish cities]]"
  - "[[_Standards/db/Common Library Network]]"
  - "[[_Standards/db/Climate Alliance]]"
  - "[[_Standards/db/World Tourism Cities Federation]]"
  - "[[_Standards/db/Hanseatic League]]"
highest point: "[[_Standards/db/Hasselbrack]]"
head of government: "[[_Standards/db/Peter Tschentscher]]"
office held by head of government: "[[_Standards/db/First Mayor of Hamburg]]"
award received: "[[_Standards/db/Führerstadt]]"
archives at: "[[_Standards/db/State Archives of the Free and Hanseatic City of Hamburg]]"
highest judicial authority: "[[_Standards/db/Hamburg Constitutional Court]]"
topic's main Wikimedia portal: "[[_Standards/db/Portal:Hamburg]]"
visitor center: "[[_Standards/db/Hamburg Tourismus]]"
open data portal: "[[_Standards/db/Transparency Portal Hamburg]]"
permanent duplicated item: "[[_Standards/db/Q62476784]]"
replaces:
  - "[[_Standards/db/Landkreis Hamburg]]"
  - "[[_Standards/db/Q62572079]]"
time of earliest written record: 0810-01-01T00:00:00Z
economy of topic: "[[_Standards/db/economy of Hamburg]]"
BHCL UUID:
...
contains the administrative territorial entity:
  - "[[_Standards/db/Hamburg-Mitte]]"
  - "[[_Standards/db/Hamburg-Nord]]"
  - "[[_Standards/db/Altona]]"
  - "[[_Standards/db/Harburg]]"
  - "[[_Standards/db/Eimsbüttel]]"
  - "[[_Standards/db/Wandsbek]]"
  - "[[_Standards/db/Bergedorf]]"
part of: "[[_Standards/db/Hamburg Metropolitan Region]]"

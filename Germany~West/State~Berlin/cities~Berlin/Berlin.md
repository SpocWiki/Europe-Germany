...
owner of:
  - "[[_Standards/db/Altes Stadthaus, Berlin]]"
  - "[[_Standards/db/Charité]]"
  - "[[_Standards/db/Poststadion]]"
  - "[[_Standards/db/Verkehrsverbund Berlin-Brandenburg]]"
  - "[[_Standards/db/Bröhan Museum]]"
  - "[[_Standards/db/Friedrich-Ludwig-Jahn-Sportpark]]"
  - "[[_Standards/db/Deutschlandhalle]]"
  - "[[_Standards/db/Funkturm Berlin]]"
  - "[[_Standards/db/Stadion An der Alten Försterei]]"
  - "[[_Standards/db/ResearchGate]]"
  - "[[_Standards/db/BEHALA]]"
  - "[[_Standards/db/Mommsenstadion]]"
  - "[[_Standards/db/Flughafen Berlin Brandenburg GmbH]]"
  - "[[_Standards/db/Olympiapark-Amateurstadion]]"
  - "[[_Standards/db/Joachimstraße 6/8]]"
  - "[[_Standards/db/Hans-Zoschke-Stadion]]"
  - "[[_Standards/db/Stadium Buschallee]]"
  - "[[_Standards/db/Wohnungsbaugesellschaft Berlin-Mitte]]"
  - "[[_Standards/db/Berliner Stadtwerke]]"
contains the administrative territorial entity:
  - "[[_Standards/db/Marzahn-Hellersdorf]]"
  - "[[_Standards/db/Steglitz-Zehlendorf]]"
  - "[[_Standards/db/Spandau]]"
  - "[[_Standards/db/Treptow-Köpenick]]"
  - "[[_Standards/db/Charlottenburg-Wilmersdorf]]"
  - "[[_Standards/db/Tempelhof-Schöneberg]]"
  - "[[_Standards/db/Reinickendorf]]"
  - "[[_Standards/db/Friedrichshain-Kreuzberg]]"
  - "[[_Standards/db/Pankow]]"
  - "[[_Standards/db/Berlin-Mitte]]"
  - "[[_Standards/db/Lichtenberg]]"
instance of:
  - "[[_Standards/db/city-state]]"
  - "[[_Standards/db/metropolis]]"
  - "[[_Standards/db/Hanseatic city]]"
  - "[[_Standards/db/federated state of Germany]]"
  - "[[_Standards/db/big city]]"
  - "[[_Standards/db/million city]]"
  - "[[_Standards/db/seat of government]]"
  - "[[_Standards/db/Einheitsgemeinde of Germany]]"
  - "[[_Standards/db/urban municipality in Germany]]"
  - "[[_Standards/db/largest city]]"
  - "[[_Standards/db/town divided by border]]"
  - "[[_Standards/db/independent city in Berlin]]"
  - "[[_Standards/db/capital city]]"
located in or next to body of water:
  - "[[_Standards/db/Dahme]]"
  - "[[_Standards/db/Aalemannkanal]]"
  - "[[_Standards/db/Neukölln Ship Canal]]"
  - "[[_Standards/db/Luisenstadt Canal]]"
  - "[[_Standards/db/Teltow Canal]]"
  - "[[_Standards/db/Landwehr Canal]]"
  - "[[_Standards/db/Müggelsee]]"
  - "[[_Standards/db/Lake Tegel]]"
  - "[[_Standards/db/Berlin-Spandau Ship Canal]]"
  - "[[_Standards/db/Westhafen Canal]]"
  - "[[_Standards/db/Gosen Canal]]"
  - "[[_Standards/db/Tegeler Fließ]]"
  - "[[_Standards/db/Großer Wannsee]]"
  - "[[_Standards/db/Havel]]"
  - "[[_Standards/db/Spree]]"
different from: "[[_Standards/db/Berlin]]"
described by source:
  - "[[_Standards/db/Catholic Encyclopedia]]"
  ...
  - "[[_Standards/db/1922 Encyclopædia Britannica]]"
  - "[[_Standards/db/The New Student's Reference Work]]"
  - "[[_Standards/db/Small Brockhaus and Efron Encyclopedic Dictionary]]"
  - "[[_Standards/db/Q19230677]]"
  - "[[_Standards/db/Great Soviet Encyclopedia (1926–1947)]]"
connects with: "[[_Standards/db/European route E55]]"
economy of topic: "[[_Standards/db/economy of Berlin]]"
replaces:
  - "[[_Standards/db/Alt-Berlin]]"
  - "[[_Standards/db/East Berlin]]"
member of:
  - "[[_Standards/db/C40 Cities Climate Leadership Group]]"
  - "[[_Standards/db/Mayors for Peace]]"
  - "[[_Standards/db/Creative Cities Network]]"
  - "[[_Standards/db/Climate Alliance]]"
  - "[[_Standards/db/World Tourism Cities Federation]]"
language used:
  - "[[_Standards/db/Berlin German]]"
  - "[[_Standards/db/German]]"
legislative body: "[[_Standards/db/Abgeordnetenhaus of Berlin]]"
office held by head of government: "[[_Standards/db/Governing Mayor of Berlin]]"
part of:
  - "[[_Standards/db/Berlin-Brandenburg Metropolitan Region]]"
  - "[[_Standards/db/agglomeration of Berlin]]"
history of topic: "[[_Standards/db/history of Berlin]]"
flag: "[[_Standards/db/flag of Berlin]]"
coat of arms: "[[_Standards/db/coat of arms of Berlin]]"
award received:
  - "[[_Standards/db/Führerstadt]]"
  - "[[_Standards/db/Princess of Asturias Award for Concord]]"
  - "[[_Standards/db/City of Design]]"
archives at: "[[_Standards/db/Landesarchiv Berlin]]"
head of government: "[[_Standards/db/Kai Wegner]]"
highest judicial authority: "[[_Standards/db/Constitutional Court of the State of Berlin]]"
topic's main Wikimedia portal: "[[_Standards/db/Portal:Berlin]]"
demographics of topic: "[[_Standards/db/demographics of Berlin]]"
located in time zone: "[[_Standards/db/Central European Standard Time (GMT+1)]]"
geography of topic: "[[_Standards/db/geography of Berlin]]"
coordinates of westernmost point: Point(13.08825 52.41961)
highest point: "[[_Standards/db/Arkenberge]]"
permanent duplicated item: "[[_Standards/db/Q21286937]]"
open data portal: "[[_Standards/db/Berlin Open Data]]"
district heating grid: "[[_Standards/db/Berliner Fernwärmenetz]]"
...
enclave within: "[[_Standards/db/Brandenburg]]"
shares border with: "[[_Standards/db/Brandenburg]]"
twinned administrative body: "[[_Standards/db/Kyiv]]"
...
public holiday: "[[_Standards/db/International Women's Day]]"

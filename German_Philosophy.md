...
dv_has_:
  name_:
    ...
    da: Tysk filosofi
    de: Deutsche Philosophie
    el: Γερμανική φιλοσοφία
    en: German philosophy
    eo: germana filozofio
    es: Filosofía alemana
    eu: Alemaniar filosofia
    fa: فلسفه آلمانی
    fr: philosophie allemande
    gl: Filosofía alemá
    he: פילוסופיה גרמנית
    hu: német filozófia
    hy: Գերմանական փիլիսոփայություն
    it: filosofia tedesca
    ja: ドイツの哲学
    kk: Неміс философиясы
    ko: 독일 철학
    la: Philosophia Germanica
    lt: vokiečių filosofija
    lv: vācu filozofija
    nn: Tysk filosofi
    pa: ਜਰਮਨ ਫ਼ਲਸਫ਼ਾ
    ps: د المان فلسفه
    pt: Filosofia alemã
    ro: Filosofia germană
    ru: немецкая философия
    sk: Nemecká filozofia
    sl: nemška filozofija
    sr: Nemačka filozofija
    tr: Alman felsefesi
    uk: німецька філософія
    uz: Nemis falsafasi
